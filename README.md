...
## Udacity React Native Nanodegree Final Project

### Try it out

Clone this project and run `npm install` and `npm start`

### Platform

This project is tested on Android platform, with device Pixel 2
...
The project is tested on Android, Pixel 2.
